                                                ...
                                                <div className="card-body">
                                                    <div className="media align-items-center d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                           ...
                                                           <Link to={"#"}><span className="fs-12">2 mins ago
                                                            </span></Link> 
                                                        </div>
                                                        <div dir="ltr">
                                                ...
                                                <div className="card-body">
                                                    <div className="media align-items-center d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            ...
                                                            <Link to={"#"}><span className="fs-12">6 Hours ago
                                                            </span></Link> 
                                                        </div>
                                                        <div dir="ltr">
                                                ...
                                                <div className="card-body">
                                                    <div className="media align-items-center d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            ...
                                                            <Link to={"#"}><span className="fs-12">10 mins ago
                                                            </span></Link> 
                                                        </div>
                                                ...
                                                <div className="card-body">
                                                    <div className="media align-items-center d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            ...
                                                            <Link to={"#"}><span className="fs-12">8 Hours ago
                                                            </span></Link> 
                                                        </div>
                                                        <div dir="ltr" className="ml-2">
...
<span className="me-1 badge bg-success badge bg-pink">{obj.weeks} Weeks</span>  
                                        ...
                                        <div className="product-img"><Link to={"#"}>
                                        ...
                                        </Link></div><div className="product-content py-2"><h6>
                                    ...
                                    <div className="row">
                                                 <div className="col-md-3 ">
                                                    <div className="card programVideo">
                                                       ...
                                                       <img className="card-img-top" src={yoga} alt="Rezingo" />
                                                 ...
                                                 <div className="col-md-3">
                                                    <div className="card programVideo">
                                                        <img className="card-img-top" src={weight} alt="Rezingo"/>
                                                        <button data-test-id="playIcon" aria-label="Play Class" className="sc-koaXiP ghcUGy mr-4" onClick={() =>
                                                          swal.fire({
                                                            html: '<video id="VisaChipCardVideo" width="600" controls><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"/></video>',
                                                            showCloseButton: true,showConfirmButton:false, width: 700,
                                                 ...
                                                 <div className="col-md-3">
                                                    <div className="card programVideo">
                                                        <img className="card-img-top" src={leg} alt="Rezingo"/>
                                                        <button data-test-id="playIcon" aria-label="Play Class" className="sc-koaXiP ghcUGy mr-4" onClick={() =>
                                                          swal.fire({
                                                            html: '<video id="VisaChipCardVideo" width="600" controls><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"/></video>',
                                                            showCloseButton: true,showConfirmButton:false, width: 700,
                                                 ...
                                                 <div className="col-md-3">
                                                    <div className="card programVideo">
                                                        <img className="card-img-top" src={spinal} alt="Rezingo"/>
                                                        <button data-test-id="playIcon" aria-label="Play Class" className="sc-koaXiP ghcUGy mr-4" onClick={() =>
                                                          swal.fire({
                                                            html: '<video id="VisaChipCardVideo" width="600" controls><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"/></video>',
                                                            showCloseButton: true,showConfirmButton:false, width: 700,
