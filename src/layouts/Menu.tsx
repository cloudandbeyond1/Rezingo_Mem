    ...
    <>
      <ul className="menu" ref={menuRef} id="main-side-menu">
        ...
        <li className="menu-item">
          <div className="side-nav-link-ref menu-link menu-link">
          <Link to={"https://rezingo.com/cloud-kitchen"} className="waves-effect waves-light btn btn-success rounded-0 py-1 " style={{backgroundColor:"#21973d", border:"#21973d", width:"7em"}}>
        Order food
        </Link>
          </div>
        </li>
        ...
        <div className="side-nav-link-ref menu-link menu-link"> 
             ...
             <button type="button" className="waves-effect waves-light btn btn-success rounded-0 py-1" style={{backgroundColor:"#21973d", border:"#21973d", width:"7em"}}>Order food</button></a></div>
        </li> */}
      </ul>
    </>
  );
